...
class _InsightsDashboardState extends State<InsightsDashboard>
  ...
  Widget _buildDailyTab() => SingleChildScrollView(
  ...
  Widget _buildWeeklyTab() => SingleChildScrollView(
        padding: const EdgeInsets.all(16.0),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
  ...
  Widget _buildMonthlyTab() => SingleChildScrollView(
        padding: const EdgeInsets.all(16.0),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            MonthlyStructureCard(
              ...
              onCardTap: _showMonthlyReportDialog,
            ),
            const SizedBox(height: 24),
  ...
  Widget _buildDailyInsights() => AppCard(
        child: Padding(
          padding: const EdgeInsets.all(16.0),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    children: [
                      Icon(
                        ...
                        color: _getInsightColor(
                            _dailyCap.latestInsight!.sentiment),
                        size: 20,
                      ),
  ...
  Widget _buildWeeklyInsights() => AppCard(
        child: Padding(
          padding: const EdgeInsets.all(16.0),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildMonthlyInsights() => Column(
        children: [
          AppCard(
            child: Padding(
              padding: const EdgeInsets.all(16.0),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  ..._monthlyHealth.recommendations.map(
