...
class _PeriodDifferenceAnalysisScreenState
  ...
  // 添加交易表单控制器
  final TextEditingController _transactionDescController =
  ...
  // 会话信息卡片
  Widget _buildSessionInfoCard() => AppCard(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Row(
  ...
  // 差额总览卡片
  Widget _buildDifferenceOverviewCard() => AppCard(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: context.responsiveBodyMedium.copyWith(
                        ...
                        color: _currentSession.explanationRate == 1.0
                            ? Colors.green
                            : Colors.blue,
                      ),
                    ),
  ...
  // 各钱包差额详情卡片
  Widget _buildWalletDifferencesCard() => AppCard(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(
  ...
  // 单个钱包差额项
  Widget _buildWalletDifferenceItem(WalletDifference walletDiff) => Padding(
                ...
                children: [
                  Expanded(
                    child: OutlinedButton.icon(
                      onPressed: () =>
                          _showAddTransactionDialog(walletDiff.walletId),
  ...
  // 已添加的交易卡片
  Widget _buildManualTransactionsCard() => AppCard(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Row(
  ...
  // 单个交易项
  Widget _buildTransactionItem(ManualTransaction transaction) => ListTile(
  ...
  // 添加交易按钮
  Widget _buildAddTransactionButton() => SizedBox(
  ...
  void _showAddTransactionDialog([String? preselectedWalletId]) {
    ...
    if (preselectedWalletId == null &&
        _currentSession.walletDifferences.isNotEmpty) {
              ...
              child: Column(
                ...
                children: [
                    ...
                    builder: (context) {
                      ...
                      final walletDiff = _selectedWalletId != null
                          ? _currentSession.walletDifferences.firstWhere(
                              (w) => w.walletId == _selectedWalletId,
                              orElse: () =>
                                  _currentSession.walletDifferences.first,
                            )
                          : null;
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: _currentSession.walletDifferences
                        .map(
                          (walletDiff) => DropdownMenuItem(
  ...
  void _showAddAmountDialog(StateSetter setDialogState) {
    ...
    var isAddMode = true; // true=累加，false=减少
                ...
                children: [
                    ...
                    Builder(
                      builder: (context) {
                        ...
                        if (addAmountText.isNotEmpty) {
                          ...
                          if (inputAmount != null && inputAmount > 0) {
                            final addAmount =
                                isAddMode ? inputAmount : -inputAmount;
                            remainingAmount =
                                calculateNewRemainingAmount(addAmount);
                          } else {
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: '请输入金额',
                      prefixText: '¥ ',
                      helperText: isAddMode ? '输入金额将累加到当前总额' : '输入金额将从当前总额中减少',
                    ),
                    keyboardType:
  ...
  Future<void> _completeClearance() async {
    ...
    try {
      final completedSession =
          await _clearanceService.completeClearanceSession(_currentSession.id);
