...
class ResponsiveTextStyles {
  ...
  // 移动端优化的文本样式
  static TextStyle getMobileTitle(BuildContext context) {
    return TextStyle(
      fontFamily: AppTheme.fontFamily,
  ...
  static TextStyle getMobileSubtitle(BuildContext context) {
    return TextStyle(
      fontFamily: AppTheme.fontFamily,
  ...
  static TextStyle getMobileBody(BuildContext context) {
    return TextStyle(
      fontFamily: AppTheme.fontFamily,
  ...
  static TextStyle getMobileCaption(BuildContext context) {
    return TextStyle(
      fontFamily: AppTheme.fontFamily,
  ...
  // 金额显示样式
  static TextStyle getAmountStyle(BuildContext context, {bool isPositive = true}) {
    return TextStyle(
      fontFamily: AppTheme.fontFamily,
  ...
  // 大金额显示样式
  static TextStyle getLargeAmountStyle(BuildContext context, {bool isPositive = true}) {
    return TextStyle(
      fontFamily: AppTheme.fontFamily,
...
extension ResponsiveTextStylesExtension on BuildContext {
  TextStyle get responsiveDisplayLarge => ResponsiveTextStyles.getDisplayLarge(this);
  TextStyle get responsiveDisplayMedium => ResponsiveTextStyles.getDisplayMedium(this);
  TextStyle get responsiveHeadlineMedium => ResponsiveTextStyles.getHeadlineMedium(this);
  TextStyle get responsiveBodyLarge => ResponsiveTextStyles.getBodyLarge(this);
  TextStyle get responsiveBodyMedium => ResponsiveTextStyles.getBodyMedium(this);
  TextStyle get responsiveLabelLarge => ResponsiveTextStyles.getLabelLarge(this);
