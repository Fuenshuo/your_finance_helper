...
class ReadOnlyResultRow extends StatelessWidget {
  ...
  const ReadOnlyResultRow({
    ...
    this.valueStyle,
    this.spacing,
  }) : assert(amount != null || customValueText != null, '必须提供 amount 或 customValueText');
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveValueColor = valueColor ?? AppDesignTokens.secondaryText(context);
    ...
    return Row(
      ...
      children: [
        ...
        Text(
          displayValue,
          style: valueStyle ?? AppDesignTokens.subtitle(context).copyWith(
