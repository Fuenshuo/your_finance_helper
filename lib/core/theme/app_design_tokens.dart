...
class AppDesignTokens {
  ...
  static Color primaryAction(BuildContext context, {AppTheme? theme}) {
    ...
    // 否则使用配置的主题颜色
    if (t == AppTheme.modernForestGreen && _currentStyle == AppStyle.iOSFintech) {
  ...
  static TextStyle primaryValue(BuildContext context) => TextStyle(
    fontSize: 26, fontWeight: FontWeight.w700, height: 1.2, letterSpacing: -0.5,
    color: _textColor(context),
  );
  ...
  static TextStyle cardTitle(BuildContext context) => TextStyle(
    fontSize: 18, fontWeight: FontWeight.w600, height: 1.3, letterSpacing: -0.3,
    color: _textColor(context),
  );
  ...
  static TextStyle subtitle(BuildContext context) => TextStyle(
    fontSize: 14, fontWeight: FontWeight.w400, height: 1.4, letterSpacing: -0.2,
  ...
  static double radiusMedium(BuildContext context, {AppStyle? style}) {
    final s = style ?? _currentStyle;
    return s == AppStyle.iOSFintech ? 16.0 : 8.0; // iOS Fintech: 16pt, SharpProfessional: 8pt
  }
  
  /// 获取大圆角（支持风格切换）
  static double radiusLarge(BuildContext context, {AppStyle? style}) {
    final s = style ?? _currentStyle;
    return s == AppStyle.iOSFintech ? 24.0 : 12.0; // iOS Fintech: 24pt, SharpProfessional: 12pt
  }
  ...
  // 为了兼容现有代码，保留旧的方法名
  static Color primaryBackground(BuildContext context) => pageBackground(context);
  ...
  static Color secondaryText(BuildContext context) => _textColor(context).withOpacity(0.6);
  static Color tertiaryText(BuildContext context) => _textColor(context).withOpacity(0.4);
  static Color dividerColor(BuildContext context) => _textColor(context).withOpacity(0.1);
  static Color borderColor(BuildContext context) => _textColor(context).withOpacity(0.1);
...
class AppTextStyles {
  ...
  static TextStyle displayLarge(BuildContext context) => AppDesignTokens.largeTitle(context);
  static TextStyle displayMedium(BuildContext context) => AppDesignTokens.title1(context);
  static TextStyle headlineMedium(BuildContext context) => AppDesignTokens.headline(context);
  static TextStyle bodyLarge(BuildContext context) => AppDesignTokens.body(context);
  static TextStyle bodyMedium(BuildContext context) => AppDesignTokens.body(context).copyWith(fontSize: 15);
  static TextStyle bodySmall(BuildContext context) => AppDesignTokens.caption(context);
  static TextStyle button(BuildContext context) => AppDesignTokens.headline(context).copyWith(color: Colors.white);
  static TextStyle label(BuildContext context) => AppDesignTokens.caption(context);
}
