...
class PersistentStorageService {
  ...
  String _getFilePath(String fileName) {
    return '${_documentsDirectory!.path}/$fileName.json';
  }
  ...
  Future<List<AssetItem>> getAssets() async {
    ...
    if (data == null || data['assets'] == null) return [];
  ...
  Future<String> exportAllData() async {
    ...
    // 保存到文件
    final file = File(_getFilePath('backup_${DateTime.now().millisecondsSinceEpoch}.json'));
    await file.writeAsString(jsonString);
