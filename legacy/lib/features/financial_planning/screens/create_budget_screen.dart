...
class _CreateBudgetScreenState extends State<CreateBudgetScreen> {
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      padding:
                          EdgeInsets.symmetric(vertical: context.spacing16),
  ...
  // 基本信息卡片
  Widget _buildBasicInfoCard() => AppCard(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(
  ...
  // 预算设置卡片
  Widget _buildBudgetSettingsCard() => AppCard(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(
  ...
  // 时间设置卡片
  Widget _buildTimeSettingsCard() => AppCard(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(
  ...
  // 高级设置卡片
  Widget _buildAdvancedSettingsCard() => AppCard(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(
  ...
  // 颜色和标签卡片
  Widget _buildColorAndTagsCard() => AppCard(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(
